...
### To run pocketmine as a docker container:
    ...
    docker run -d -it --restart=always -p 19132:19132/tcp -p 19132:19132/udp --name pocketmine magicalyak/pocketmine
...
Then run the container with these added option:
    ...
    docker run -d -it --restart=always -p 19132:19132/tcp -p 19132:19132/udp  -v /srv/pocketmine:/data --name pocketmine magicalyak/pocketmine
